...
contract PoolFactory {
    ...
    //@written the error iis not used
    error PoolFactory__PoolDoesNotExist(address tokenAddress);

    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    mapping(address token => address pool) private s_pools; // e probably token to pool
    mapping(address pool => address token) private s_tokens; // e above bakword
    ...
    constructor(address wethToken) {
        //@ written missing zero address check
    ...
    function createPool(address tokenAddress) external returns (address) {
        ...
        //e "Tswap dai"
        //q weird ERC20 "what if the  name funtion revert"

        string memory liquidityTokenName = string.concat("T-Swap ", IERC20(tokenAddress).name());

        //@written this should be the symbol not .name()
