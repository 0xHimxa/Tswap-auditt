...
contract TSwapPool is ERC20 {
    ...
    function deposit(
        ...
        //@audit - heigh deadline not been used
        //if some one set a deadline,let say next blok they ould still deposit
        //impact: Hight user who expet this to fail, will go through
        // severe disruption of funtionality
        uint64 deadline
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
           ...
           //@ audit-gas dont need this line
            ...
            //@audit-info it would be better this should be before the addliquidity to follow CEI
        ...
        private
    {
      ...
      //@audit- low the event is emitted bakwords
      //impacct low
      //likely wood: High
...
//instad of 1000: you  use 10000 which charge use 91.3% for fee?

        //@audit -High
        //IMAPCT: Hight -> users  are charged whay to much
    ...
    //@audit-info whare is the natspac???
    function swapExactInput(
        ...
        ///@audit-low
        ///impact: Low - protool giving out wrong return
        ///likelyhood : low
     ...
     * @audit-Info missing deadin param in natspec
     */
    ...
    function sellPoolTokens(uint256 poolTokenAmount) external returns (uint256 wethAmount) {
      ...
      //@audit this is wrong:
      // the param is been passed in the wrong other
    ...
    function _swap(IERC20 inputToken, uint256 inputAmount, IERC20 outputToken, uint256 outputAmount) private {
        ...
        //@audit breakes protool invariants
        swap_count++;
